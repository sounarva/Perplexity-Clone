    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col relative text-white font-sans overflow-hidden">
      ...
      {verifyEmailModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-overlay-fade">
          <div className="w-full max-w-md bg-[#121214] border border-[#2d2d33] rounded-2xl p-8 shadow-2xl relative animate-popup">
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-bold mb-3 tracking-tight">Registration Successful!</h2>
      ...
      <div className="flex-1 flex items-center justify-center p-4 pt-12 pb-12">
