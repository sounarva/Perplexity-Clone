    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col relative text-white font-sans overflow-hidden">
      ...
      {resetLinkModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-[380px] bg-[#121214] border border-[#2d2d33] rounded-2xl p-6 sm:p-8 shadow-2xl flex flex-col items-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-white">Reset your password</h2>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pt-28 pb-12 md:px-4 z-10">
        <div className="w-full max-w-[360px] sm:max-w-[400px] m-auto bg-[#121214] border border-[#2d2d33] rounded-2xl p-6 sm:p-8 shadow-2xl">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-gray-400 text-[13px] sm:text-sm">Enter your credentials to access your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="block text-[13px] sm:text-sm font-medium text-gray-300" htmlFor="password">Password</label>
                <div
                  className="text-[13px] sm:text-sm text-[#22d3ee] hover:underline cursor-pointer font-medium transition-colors"
